...
/**
 * Class CMF_Core_Image_Abstract extends base XenForo_Image_Abstract class to add ability
 * to generate square thumbnails
 */
abstract class CMF_Core_Image_Abstract extends XFCP_CMF_Core_Image_Abstract
{
	/**
